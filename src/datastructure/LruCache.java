...
class LRUCacheProblem {
	...
	private Hashtable<String, Node> cache;
	private int count;
	...
	private void moveToHead(Node node) {
		...
		//update references, removing current node
		tail = node.prev;
	...
	public LRUCacheProblem(int capacity) {
		...
		cache = new Hashtable<String, Node>();
	...
	public static void main(String[] args) {
		...
		assertTest(testCount, "should be able to set and get key-value pairs", new Test() {
			public boolean execute() {
				...
				LRUCacheProblem lruCache = new LRUCacheProblem(3);
				lruCache.set("doc", "david");
				lruCache.set("cpo", "joshua");
				lruCache.set("ceo", "andy");
